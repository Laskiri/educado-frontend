    ...
    <body className='w-full h-screen'>
      <div className='grid grid-cols-1 md:grid-cols-2 m-auto h-screen sm:max-w-956'> 
        ...
        <div className="relative right-0 h-screen flex flex-col justify-center items-center">
          <img className="relative pt-10 w-[22rem]" src={FrontLogo} alt="Front Logo" />
          <h1 className="relative text-2xl font-['Montserrat'] text-[#A1ACB2] text-center mb-6 mt-4">
          ...
          <div className="relative flex gap-4 px-[5rem] flex-row items-center justify-center w-full">
