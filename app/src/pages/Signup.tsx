...
const SignupSchema = Yup.object().shape({
  ...
  password: Yup.string().min(8, 'Muito curto!').required("A senha não é longa o suficiente"),
        ...
        if (!err.response?.data) {
          ...
          switch (err.response.data.error.code) {
            case "E0201": // Email already exists
              ...
              setErrorExistMessage("Já existe um usuário com o email fornecido");
        ...
        <div className='relative right-0 h-screen flex flex-col justify-center items-center'>
          ...
          <div className='relative py-8 px-10 w-full'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="stretch flex flex-col">
              <div className="flex">
                <div className="relative flex-1">
                  ...
                  <input onInput={areFieldsFilled}
                    ...
                    placeholder="Nome"
                    {...register("firstName", { required: "digite seu primeiro nome." })} />
                </div>
                ...
                <div className="relative flex-1 ml-2">
                  ...
                  <input onInput={areFieldsFilled}
                    ...
                    {...register("lastName", { required: "digite seu sobrenome." })} />
                </div>
              </div>

              <div className="relative">
                <label className="flex flex-start text-[#383838] text-sm font-normal gap-1 font-['Montserrat'] mt-5 after:content-['*'] after:ml-0.5 after:text-red-500 " htmlFor="email-field">
                  Email
                </label>
                <input onInput={areFieldsFilled}
              ...
              <button type="submit" id="submit-signup-button" className="disabled:opacity-20 disabled:bg-slate-600 flex-auto w-[100%] h-[3.3rem] rounded-lg bg-[#166276] text-[#FFF] transition duration-100 ease-in hover:bg-cyan-900 hover:text-gray-50 text-lg font-bold font-['Montserrat']" disabled>
                Cadastrar
              </button>
              ...
              <div className="flex justify-center space-x-1">
                <span className="text-[#A1ACB2] text-lg font-normal font-['Montserrat']">Já possui conta?</span>
                <Link to="/login" className="text-[#383838] text-lg font-normal font-['Montserrat'] underline hover:text-blue-500 gap-6">Entre agora</Link>
              </div>
            </form>
          </div>
        </div>
