  ...
  <body className="relative right-0 h-full flex-1 flex flex-col z-10">
    <form className="relative right-0 w-full overflow-none flex-1 h-screen flex flex-col items-center gap-5 z-50" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="items-center p-10 pt-20">
        ...
        <p className="text-center text-neutral-700 text-lg font-normal font-['Montserrat'] max-w-4xl">
      ...
      <div className="w-[65%] flex justify-between ">
        ...
        <button type="submit" className=" h-[52px] px-10 py-4 bg-cyan-800 hover:bg-cyan-900 rounded-lg justify-center items-start gap-2.5 inline-flex text-center text-white text-lg font-bold font-['Montserrat']">
