...
export const CourseComponent = ({ token, id, setTickChange, setId }: CourseComponentProps) => {
  ...
  if (id != "0") {
    var { data, error } = useSWR(token ? [`${BACKEND_URL}/api/courses/${id}`, token] : null, getData);
  }
  ...
  return (
    <div>
      <div className="w-full flex flex-row py-5">
        ...
        <ToolTipIcon index={0} toolTipIndex={toolTipIndex} text={"👩🏻‍🏫Nossos cursos são separados em seções e você pode adicionar quantas quiser!"} tooltipAmount={5} callBack={setToolTipIndex} />
      </div>
        ...
        <form className="flex h-full flex-col justify-between space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center gap-8 w-full mt-8">
            ...
            <div className="flex flex-col w-1/2 space-y-2 text-left  ">
              <div className="flex flex-row items-center">
                ...
                <div className="w-full flex flex-row py-0">
                  {/** Tooltip for course header*/}
                  <ToolTipIcon index={1} toolTipIndex={toolTipIndex} text={"Her er noget mere info"} tooltipAmount={5} callBack={setToolTipIndex} />
                </div>
              </div>
              <select
                id="difficulty-field"
            ...
            <div className="flex flex-col w-1/2 space-y-2 text-left  ">
              <div className="flex flex-row items-center">
                ...
                <div className="w-full flex flex-row py-0">
                  {/** Tooltip for course header*/}
                  <ToolTipIcon index={2} toolTipIndex={toolTipIndex} text={"Her er noget mere info"} tooltipAmount={5} callBack={setToolTipIndex} />
                </div>
              </div>
              <select
                id="category-field"
          ...
          <div className="flex flex-col space-y-2 ">
            <div className="flex items-center space-x-2">
              ...
              {/** Description */}
              <ToolTipIcon index={3} toolTipIndex={toolTipIndex} text={"😉 Dica: insira uma descrição que desperte a curiosidade e o interesse dos alunos"} tooltipAmount={5} callBack={setToolTipIndex} />
            </div>
            <textarea
          ...
          <div>
            ...
            <div className="flex flex-row items-center">
              ...
              <div className="w-half flex flex-row py-0">
                {/** Tooltip for course header*/}
                <ToolTipIcon index={4} toolTipIndex={toolTipIndex} text={"Her er noget mere info"} tooltipAmount={5} callBack={setToolTipIndex} />
              </div>
            </div>
          ...
          <div className="modal-action">
            <div className="flex items-center justify-between gap-4 w-full mt-8">
              <label
                ...
                className="cursor-pointer underline py-2 px-4 bg-transparent hover:bg-warning-100 text-warning w-full transition ease-in duration-200 text-center text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2  rounded"
              >
              ...
              <label
                htmlFor="course-create"
                className="ml-56 underline py-2 px-4 bg-transparent hover:bg-primary-100 text-primary w-full transition ease-in duration-200 text-center text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2  rounded"
              >
              ...
              <label
                htmlFor="course-create"
                className="h-12 p-2 bg-primary hover:bg-primary focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-lg font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
              >
